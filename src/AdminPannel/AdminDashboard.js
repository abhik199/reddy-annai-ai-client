        ...
        <aside className="sidebar">
          <nav>
            <ul>
              ...
              <li>
                <Link to="/cardForm">Add Card Form</Link>
              </li>
              <li>
                <Link to="/sliderForm">Add Slider Form</Link>
              </li>
            </ul>
          </nav>
        </aside>
        <main className="main-content">
          ...
          <section className="social-stats">
            <div className="social-card">
              <FaFacebookF />
              <br /> 35k Friends 128 Feeds
            </div>
            <div className="social-card">
              <FaTwitter />
              <br /> 584k Followers 978 Tweets
            </div>
            <div className="social-card">
              <FaLinkedinIn /> <br />
              758+ Contacts 365 Feeds
            </div>
            <div className="social-card">
              <FaGooglePlusG />
              <br /> 450 Followers 57 Circles
            </div>
          </section>
        </main>
      </div>
